              ...
              <form onSubmit={handleSubmit} className="mt-9">
                <div className="flex gap-2">
                  <input
                    ...
                    required
                    className="flex-1 rounded-lg border border-white/10 bg-white/[0.04] px-4 py-[11px] text-sm text-white/90 placeholder-white/20 outline-none transition-all duration-200 focus:border-white/25 focus:bg-white/[0.07]"
                    style={{ fontFamily: '"Outfit", sans-serif' }}
                  />
                  <button
                    type="submit"
                    disabled={status === "loading"}
                    className="rounded-lg border border-white/15 bg-white/10 px-[22px] py-[11px] text-sm font-medium text-white/80 whitespace-nowrap transition-all duration-200 hover:bg-white/[0.18] hover:border-white/25 hover:text-white/95 active:scale-[0.97] disabled:opacity-50 disabled:pointer-events-none"
                    style={{ fontFamily: '"Outfit", sans-serif' }}
                  >
